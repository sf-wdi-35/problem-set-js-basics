...
var generateInsult = function() {
  var generateWord = function(anyWord) {
    var anyPickedWord= anyWord[Math.floor(Math.random()*anyWord.length)];
    return anyPickedWord;
  }
  return generateWord(first_word) + " " + generateWord(second_word) +" "+ generateWord(third_word);
}
