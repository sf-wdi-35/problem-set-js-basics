...
var generateInsult = function() {
  var firstWord = first_word[Math.floor(first_word.length * (Math.random()))];
  var secondWord = second_word[Math.floor(second_word.length * (Math.random()))];
  var thirdWord = third_word[Math.floor(third_word.length * (Math.random()))];

  return "You " + firstWord + ", " + secondWord + ", " + thirdWord + ", you!";
}
