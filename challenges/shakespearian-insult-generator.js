...
var generateInsult = function(num){
  var first = first_word[Math.floor(Math.random() * first_word.length)];
  var second = second_word[Math.floor(Math.random() * second_word.length)];
  var third = third_word[Math.floor(Math.random() * third_word.length)];
  console.log("You " + first + " " + second + " " + third ".");
}
