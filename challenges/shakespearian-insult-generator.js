...
var generateInsult = function() {
  var generateWordFirst = first_word[Math.floor(Math.random() * first_word.length)];
  var generateWordSecond = second_word[Math.floor(Math.random() * second_word.length)];
  var generateWordThird = third_word[Math.floor(Math.random() * third_word.length)];
    return (generateWordFirst + " " + generateWordSecond + " " + generateWordThird + "!")
  };
