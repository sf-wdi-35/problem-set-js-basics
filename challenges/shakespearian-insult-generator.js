/*
  ...
  - Allow the user to supply a proper name as an input.
  ("Why Justin, you villainous toad-spotted strumpet!").
...
var first_word = first_word[computerChoice];
var second_word = second_word[computerChoice];
var third_word = third_word[computerChoice];

var insult ="Why" + " " + name + " you " + first_word +  " " + second_word + " " + third_word + "!";

return insult;
}

console.log(generateInsult("Harry Potter"));
