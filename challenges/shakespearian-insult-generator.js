...
// Generates randomNum & assigns it to word within an array
var insultMe = function(arr){
  var randomNum = Math.floor(Math.random() * arr.length-1);
  return(arr[randomNum]);
}

// Handles output
var output = "Why you " + insultMe(first_word)+ ", " + insultMe(second_word)+ ", " + insultMe(third_word) + "!";
console.log(output);
