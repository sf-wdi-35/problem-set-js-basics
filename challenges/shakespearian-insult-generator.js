...
// var word1 = first_word[Math.floor(Math.random()*first_word.length)];
// var word2 = second_word[Math.floor(Math.random()*second_word.length)];
// var word3 = third_word[Math.floor(Math.random()*third_word.length)];
...
function generateInsult(num) {
  for (var i = 0; i < num; i++) {
    ...
    var word2 = second_word[Math.floor(Math.random()*second_word.length)];
    var word3 = third_word[Math.floor(Math.random()*third_word.length)];
    console.log("Why you " + word1 + " " + word2 + " " + word3 + "!")
  }
}
